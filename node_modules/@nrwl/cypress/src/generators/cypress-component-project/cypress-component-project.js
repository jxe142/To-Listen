...
function updateNxJson(tree) {
    ...
    workspaceConfiguration.tasksRunnerOptions = Object.assign(Object.assign({}, workspaceConfiguration === null || workspaceConfiguration === void 0 ? void 0 : workspaceConfiguration.tasksRunnerOptions), { default: Object.assign(Object.assign({}, (_a = workspaceConfiguration === null || workspaceConfiguration === void 0 ? void 0 : workspaceConfiguration.tasksRunnerOptions) === null || _a === void 0 ? void 0 : _a.default), { options: Object.assign(Object.assign({}, (_c = (_b = workspaceConfiguration === null || workspaceConfiguration === void 0 ? void 0 : workspaceConfiguration.tasksRunnerOptions) === null || _b === void 0 ? void 0 : _b.default) === null || _c === void 0 ? void 0 : _c.options), { cacheableOperations: Array.from(new Set([
                    ...((_g = (_f = (_e = (_d = workspaceConfiguration === null || workspaceConfiguration === void 0 ? void 0 : workspaceConfiguration.tasksRunnerOptions) === null || _d === void 0 ? void 0 : _d.default) === null || _e === void 0 ? void 0 : _e.options) === null || _f === void 0 ? void 0 : _f.cacheableOperations) !== null && _g !== void 0 ? _g : []),
                    'component-test',
                ])) }) }) });
    if (workspaceConfiguration.namedInputs) {
        (_h = workspaceConfiguration.targetDefaults) !== null && _h !== void 0 ? _h : (workspaceConfiguration.targetDefaults = {});
        const productionFileSet = (_j = workspaceConfiguration.namedInputs) === null || _j === void 0 ? void 0 : _j.production;
        if (productionFileSet) {
            workspaceConfiguration.namedInputs.production = Array.from(new Set([
                ...productionFileSet,
                '!{projectRoot}/cypress/**/*',
        ...
        (_k = (_m = workspaceConfiguration.targetDefaults)['component-test']) !== null && _k !== void 0 ? _k : (_m['component-test'] = {});
        (_l = (_o = workspaceConfiguration.targetDefaults['component-test']).inputs) !== null && _l !== void 0 ? _l : (_o.inputs = [
            'default',
