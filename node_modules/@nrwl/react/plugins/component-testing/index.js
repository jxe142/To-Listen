...
function buildTargetWebpack(graph, buildTarget, componentTestingProjectName) {
    ...
    const options = normalizeOptions(withSchemaDefaults(parsed, context), devkit_1.workspaceRoot, buildableProjectConfig.sourceRoot);
    ...
    const defaultWebpack = getWebpackConfig(context, options, true, isScriptOptimizeOn, {
